...
<article class="node-<?php print $node->nid; ?> <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php endif; ?>
	<div class="blog-left-sidebar">
    	<?php //print strip_tags($user_picture,'<span><img>'); ?>
    	<?php
		//dsm($content);
		if ($node->field_post_icon) {
			print render($content['field_post_icon']);
		}
		else if ($view_mode == 'full') {
			print strip_tags($user_picture,'<span><img>');
		}
		print displayAuthorPostInfo($name,$comment_count);
		?>
    </div>
  ...
  ?>
	...
	<?php if ($view_mode == 'teaser'): ?>
        <div class="readmore"><?php print t('<a href="@node_url">Read post</a>',array('@node_url' => $node_url)); ?> </div>
    <?php endif; ?>
	<?php 
	//dsm($content['comments']);
